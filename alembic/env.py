...
from nexus.db import models  # noqa: F401 — register all models
...
# Override the URL from settings (source of truth).
...
def run_migrations_offline() -> None:
    """Run migrations in 'offline' mode using the async URL."""
    context.configure(
